...
export class DefaultAssessmentTemplateSeed {
  ...
  async run(): Promise<void> {
    ...
    const templateConfig = {
      version: '1.0',
      description: '系统内置的标准考核模板，包含工作绩效、日常管理和领导评价三大维度',
          ...
          items: [
            {
              ...
              max_score: 100,
              scoring_criteria: {
                excellent: { min: 90, description: '工作安排合理，时间利用率高' },
            ...
            },
            {
              ...
              max_score: 100,
              scoring_criteria: {
                excellent: { min: 90, description: '执行力强，能够超额完成任务' },
          ...
          items: [
            {
              ...
              max_score: 100,
              scoring_criteria: {
                excellent: { min: 90, description: '专项任务完成出色，反馈及时详细' },
    ...
    const template = templateRepository.create({
      name: '系统默认考核模板',
      description: '系统内置的标准化绩效考核模板，包含工作绩效(60%)、日常管理(30%)、领导评价(10%)三个维度的全面评估',
      type: 'assessment',
    ...
    console.log('- 日常管理 (30%): 工作态度、审批流程、出勤、汇报、团队活动、环境维护、制度遵守');
